...
<template>
  <div class="w-full h-full bg-white">
    ...
    <div class="p-12">
      <h2 class="font-normal tracking-widest text-gray-700 opacity-90">
        hrdtr.dev
      </h2>
      <div
        class="flex flex-col h-full relative mt-16"
        style="z-index: 10"
      >
        <div class="my-auto">
          <h1 class="text-7xl text-gray-900 mb-12">
            {{ props.title || "Herdi Tr." }}
          </h1>
        </div>
      </div>
    </div>
