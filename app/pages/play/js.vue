...
<template>
  <div class="w-full h-dvh flex flex-col relative overflow-hidden">
    <div
      class="h-[60dvh] flex flex-col transition-all duration-300 ease-in-out"
    ...
    >
      <div class="p-2 border-b border-background-content/10 flex flex-row items-center justify-between">
        ...
        >
          <button
            class="px-2 py-1 flex-shrink-0 text-sm rounded border border-background-content/10 transition inline-flex items-center"
            :class="editorTab === 'js' ? 'bg-background-content/5' : 'bg-transparent hover:bg-background-content/10 opacity-65 hover:opacity-100'"
            type="button"
            role="tab"
            tabindex="0"
          ...
          <button
            class="px-2 py-1 flex-shrink-0 text-sm rounded border border-background-content/10 transition inline-flex items-center"
            :class="editorTab === 'html' ? 'bg-background-content/5' : 'bg-transparent hover:bg-background-content/10 opacity-65 hover:opacity-100'"
            type="button"
            role="tab"
            tabindex="0"
          ...
          <button
            class="px-2 py-1 flex-shrink-0 text-sm rounded border border-background-content/10 transition inline-flex items-center"
            :class="editorTab === 'css' ? 'bg-background-content/5' : 'bg-transparent hover:bg-background-content/10 opacity-65 hover:opacity-100'"
            type="button"
            role="tab"
            tabindex="0"
    ...
    <div class="flex-shrink-0 flex-1 flex flex-col overflow-hidden">
      <div class="p-2 border-y border-background-content/10 flex flex-row items-center justify-between">
        ...
        >
          <button
            class="px-2 py-1 flex-shrink-0 text-sm rounded border border-background-content/10 transition inline-flex items-center"
            :class="outputTab === 'consoleOutput' ? 'bg-background-content/5' : 'bg-transparent hover:bg-background-content/10 opacity-65 hover:opacity-100'"
            type="button"
            role="tab"
            tabindex="0"
          ...
          <button
            class="px-2 py-1 flex-shrink-0 text-sm rounded border border-background-content/10 transition inline-flex items-center"
            :class="outputTab === 'documentPreview' ? 'bg-background-content/5' : 'bg-transparent hover:bg-background-content/10 opacity-65 hover:opacity-100'"
            type="button"
            role="tab"
            tabindex="0"
