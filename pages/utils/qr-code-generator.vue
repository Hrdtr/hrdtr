...
const generate = () => {
  ...
  output.value = `https://chart.googleapis.com/chart?cht=qr&chl=${encodeURIComponent(input.value)}&chs=180x180&choe=UTF-8&chld=${errorCorrectionLevel.value}|2`
    ...
    <template #default>
      <div class="flex flex-col gap-4">
        ...
        >
          ...
          <div>
            <img
              class="object-contain w-full sm:max-w-[50%] 2xl:max-w-[40%]"
              :src="output"
            >
          </div>
        </div>
      ...
      <ul class="list-disc list-inside">
        <li class="ml-px">
          <UButton
            :padded="false"
            variant="link"
            to="/utils/wifi-qr-code-generator/"
          >
